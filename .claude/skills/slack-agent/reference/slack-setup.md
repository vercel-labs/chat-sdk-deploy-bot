...
**The webhook URL is:** `https://your-domain.vercel.app/api/webhooks/slack`
...
3. Add it as a query parameter to your URL:
...
Then update your Slack app's manifest with the ngrok URL: `https://abc123.ngrok.io/api/webhooks/slack`
...
2. Check the URL is correct and accessible: `/api/webhooks/slack`
3. Verify your endpoint returns the `challenge` parameter correctly (the Chat SDK handles this automatically)
