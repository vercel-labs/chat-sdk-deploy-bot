...
4. Configure project settings:
   - Framework Preset = **Next.js**, Output Directory = `.next` (auto-detected)
...
2. Update **Request URL** to: `https://your-app.vercel.app/api/webhooks/slack`
...
2. Edit each command
3. Update **Request URL** to: `https://your-app.vercel.app/api/webhooks/slack`
4. Click **Save**
...
3. Verify your endpoint handles the challenge correctly (the Chat SDK does this automatically)
